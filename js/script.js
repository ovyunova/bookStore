...
//         "price":875,
//         "url":"superpotrebiteli",
//         "type":"marketing"},
//         {
//         "name":"Как устроена экономика",
//         "desc":"",
//         "price":731,
//         "url":"kak-ustroena-ekonomika",
//         "type":"science"},
//         {
//         "name":"Дзен-камера",
...
//         "price":731,
//         "url":"byt-nachalnikom-eto-normalno",
//         "type":"business"},
//         {
//         "name":"Scrum",
...
//         "price":718,
//         "url":"i-botaniki-delayut-biznes-1-2",
//         "type":"business"},
//         {
...
//         "desc":"",
//         "price":646,
//         "url":"simpsony-i-ikh-matematicheskie-sekrety",
//         "type":"science"},
//         {
//         "name":"Преломление",
...
//         "price":773,
//         "url":"literaturnyy-master-klass",
//         "type":"creativity"},
//         {
//         "name":"Все начальники делают это",
//         "desc":"Пошаговое руководство по решению (почти) всех проблем менеджера",
//         "price":744,
//         "url":"vse-nachalniki-delayut-eto",
//         "type":"business"}
//       ]
// };

// const catalog = document.querySelector('.j-cards');
// const elements = document.querySelectorAll('.products-card-mini');

// function createCards (data) {
//     const cardArr = data.items;
//     let cardString = ``;

//     cardArr.forEach(function(item) {
//         cardString = cardString + `<div class="products-card-mini">
//               <h2 class="products-card-mini__title">
//                 <a href="${item.url}">${item.name}</a>
//               </h2>
//               <a href="${item.url}" class="products-card-mini__img-wrap">
//                 <img src="#" class="products-card-mini__img">
//               </a>
//               <p class="products-card-mini__descr">${item.desc} </p>
//               <div class="products-card-mini__price">${item.price} &#8381</div>
//             </div>`
// });
// return cardString;
// };

// function insertElement(data, wrap) {
//     const html = createCards(data);
//     wrap.innerHTML = html;
// };

// insertElement(data, catalog);
